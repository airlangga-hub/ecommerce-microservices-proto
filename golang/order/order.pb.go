...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\"J\n" +
	"\x12CreateOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x1b\n" +
	"\x05items\x18\x02 \x03(\v2\x05.ItemR\x05items\"d\n" +
	"\x04Item\x12!\n" +
	"\fproduct_code\x18\x01 \x01(\tR\vproductCode\x12\x1d\n" +
	"\n" +
	"unit_price\x18\x02 \x01(\x01R\tunitPrice\x12\x1a\n" +
	"\bquantity\x18\x03 \x01(\x03R\bquantity\"0\n" +
	"\x13CreateOrderResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId2J\n" +
	"\fOrderService\x12:\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00BEZCgithub.com/airlangga-hub/ecommerce-microservices-proto/golang/orderb\x06proto3"
